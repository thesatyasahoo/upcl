...
const Data: any = require('./pending.json');
// Start For 1
...
@Component({
  selector: 'app-pendingConnections',
  templateUrl: './pendingConnections.component.html',
  styleUrls: ['./pendingConnections.component.scss'],
})
